...
void Game::placeBoatRandomly()
{
    ...
    std::uniform_int_distribution<int> uniformIntegerDistributionRows(0, (this->
    m_nGridRows - 1));
...
std::tuple<int, int> Game::promptForGridCoord() {
    ...
    std::cout << "Please enter a grid row number: ";
    std::cin >> iRow;
    
    std::cout << "Please enter a grid column number: ";
    std::cin >> iColumn;
    // /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\ //
